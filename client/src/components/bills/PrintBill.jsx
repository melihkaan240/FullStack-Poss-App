                ...
                <table className="min-w-full divide-y divide-slate-500 overflow-hidden">
                  <thead>
                    <tr className="border-b border-slate-200">
                      ...
                      <th
                        scope="col"
                        className="py-3.5 text-left  sm:table-cell hidden text-sm font-normal text-slate-700 sm:pl-6 md:pl-0 "
                      >
                        Başlık
                      </th>
                      <th
                        scope="col"
                        colSpan={4}
                        className="py-3.5 text-left sm:hidden text-sm font-normal text-slate-700 sm:pl-6 md:pl-0 "
                      >
                        Başlık
                      </th>
                      <th
                  ...
                  <tfoot>
                    <tr>
                      <th
                        className="text-right pt-6 sm:table-cell hidden"
                        colSpan="4"
                        scope="row"
                      >
